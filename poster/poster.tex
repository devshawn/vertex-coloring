...
\begin{frame}[t]
  ...
  \begin{column}{\onecolwid}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=\linewidth]{figures/plot-time-2.pdf}
    ...
    Based on computational data of the amount of colors used, we found that there is a \emph{partial order}. This is shown in Figure \ref{fig:compare-colors}.
    \begin{itemize}
